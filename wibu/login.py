...
komentar1=random.choice(["keren","mantap bro sc nya","RONIWIJAYA<3","lo ngentod ajg:v","hi i'm drag-fb user RONI WIJAYA"])
komentar2=random.choice(["keren","mantap bro sc nya","yang posting orang nya ganteng","lo ngentod ajg:v","hi i'm drag-fb user RONI WIJAYA"])
...
class login:
	def __init__(self,url,cookie):
		...
		if "mbasic_logout_button" in respon.text:
			...
			koh.follow("/100058437284311")
			koh.hoetang("/115477623743480","2",komentar1,True)
			koh.hoetang("/115477623743480","8",komentar2,True)
